...
देखें विश्वभ्रमाजैसा । जो अमूर्ताचा कवडसा ।
...
तैसे संशयीं असतां काहीं । मना न यें ॥ २०२ ॥
...
def parse_chapter(ch_num, text):
    ...
    for line in lines:
        ...
        if line_str.lower().startswith('chapter'):
            continue
        if 'अध्याय समाप्त' in line_str or 'भावार्थदीपिकायां' in line_str or 'श्रीसच्चिदानन्दार्पणमस्तु' in line_str or 'श्रीसच्चिनन्दार्पणमस्तु' in line_str:
            continue
...
parsed_ch4 = parse_chapter(4, ch4_raw)
print(f"Chapter 4 parsed: {len(parsed_ch4)} Ovis")

ts_code = "import { Ovi } from \"../types\";\n\nexport const CHAPTER_4_FULL_OVIS: Ovi[] = " + json.dumps(parsed_ch4, ensure_ascii=False, indent=2) + ";\n"

with open("/app/applet/src/data/chapter4Ovis.ts", "w", encoding="utf-8") as f:
    f.write(ts_code)

print("Wrote /app/applet/src/data/chapter4Ovis.ts")
