...
जेणे अंतःकरण बोधलें । संकल्पा न यें ॥ १६८ ॥
...
def parse_ovis(ch_num, text):
    ...
    for line in lines:
        ...
        if line_str.lower().startswith('chapter'):
            continue
        if line_str.endswith('अध्याय समाप्त') or 'भावार्थदीपिकायां' in line_str or 'श्रीसच्चिदानन्दार्पणमस्तु' in line_str:
            continue
            
        current_chunk.append(line_str)
        
        # Match verse ending marker ॥ 123 ॥ or || 123 ||
...
parsed_ch4 = parse_ovis(4, ch4_raw)
print("Chapter 4 parsed count:", len(parsed_ch4))

ts_code = f"""import { { "Ovi" } } from "../types";
...
print("Wrote chapter4Ovis.ts successfully!")
